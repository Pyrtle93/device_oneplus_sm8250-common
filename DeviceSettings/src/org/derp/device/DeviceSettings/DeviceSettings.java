...
*
*/
package org.derp.device.DeviceSettings;
...
import org.derp.device.DeviceSettings.FileUtils;
import org.derp.device.DeviceSettings.preferences.ProperSeekBarPreference;
...
public class DeviceSettings extends PreferenceFragment
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mFpsInfo) {
            ...
            Intent fpsinfo = new Intent(this.getContext(), org.derp.device.DeviceSettings.FPSInfoService.class);
            if (enabled) {
            ...
            Intent hbmIntent = new Intent(this.getContext(),
                    org.derp.device.DeviceSettings.HBMModeService.class);
            if (enabled) {
